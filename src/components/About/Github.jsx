...
function VideoStats() {
  ...
  return (
    <Row style={{ justifyContent: "center", paddingBottom: "50px", color:"#fff" }} data-aos="fade-up" data-aos-duration="3000">
      <h1 className="project-heading" style={{ color: "#c889e6", textAlign: "center", marginBottom: "30px" }}>
          ...
          <Col xs={12} md={6} lg={3} key={index} className="mb-4">
            ...
            >
              <Card.Body className="text-center py-4">
                <div style={{ fontSize: "2.5rem", color: stat.color, marginBottom: "15px" }}>
                  {stat.icon}
                </div>
                <h2 style={{ fontSize: "2.5rem", fontWeight: "bold", color: stat.color }}>
                  {stat.count}
                </h2>
